...
public class HttpClientUtil {
    ...
    private static final int READ_TIMEOUT = 20000;     //读取超时2s
...
//            Header h2 = httppost.getLastHeader("X-WSSE");  
//            System.out.println(h2); 
            
            response = httpClient.execute(httppost);
            StatusLine state = response.getStatusLine();
            
            System.out.println("请求状态"+state.getStatusCode()+":"+state.getReasonPhrase());
